...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $stmt->bindValue("nome",$nome_produto);
    $stmt->bindValue("preco",$preco_produto);
...
<head>
    ...
    <title>Cadastro Produto - Padaria Pão Fofo</title>
...
<body>
    ...
    <div class="container mt-5 justify-content-center">
        <p class="h1 text-center mb-5">Cadastrar Produto</p>
        <form action="cadastro_produto.php" method="post" class="mb-3">
            <div class="mb-3 mt-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="preco" id="preco" class="form-control" min="0" placeholder="5,20" required/>
            </div>
